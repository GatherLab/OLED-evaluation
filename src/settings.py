...
class Settings(QtWidgets.QDialog, Ui_Settings):
    ...
    def __init__(self, parent=None):
        ...
        self.autodetect_spectrum_toggleSwitch.setChecked(
            bool(settings["autodetect_spectrum"])
        )
    ...
    def save_settings(self):
        ...
        settings_data["overwrite"] = {
            ...
            "autodetect_spectrum": self.autodetect_spectrum_toggleSwitch.isChecked(),
    ...
    def load_defaults(self):
        ...
        self.autodetect_spectrum_toggleSwitch.setChecked(
            bool(default_settings["autodetect_spectrum"])
        )
