...
class Ui_ShowGroup(object):
    def setupUi(self, ShowGroup):
        ...
        ShowGroup.setWindowTitle("Show Group Dialog")
        ShowGroup.resize(400, 100)
        ShowGroup.setStyleSheet(
            "QWidget {\n"
        ...
        self.verticalLayout = QtWidgets.QVBoxLayout(ShowGroup)
        ...
        self.retranslateUi(ShowGroup)
        QtCore.QMetaObject.connectSlotsByName(ShowGroup)

    def retranslateUi(self, ShowGroup):
        _translate = QtCore.QCoreApplication.translate
        ShowGroup.setWindowTitle(_translate("ShowGroup", "Show Groups"))

        self.header_label.setText(
            _translate("ShowGroup", "Select Device or Group to Plot")
        )
        self.devices_label.setText(_translate("ShowGroup", "Device"))
        self.group_label.setText(_translate("ShowGroup", "Group"))
